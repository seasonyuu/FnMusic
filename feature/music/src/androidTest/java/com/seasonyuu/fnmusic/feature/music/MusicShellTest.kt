...
class MusicShellTest {
    ...
    @Test
    fun playerOmitsUnavailableShuffleAndRepeatButExposesQueue() {
        ...
        compose.onNodeWithText("待播队列").assertIsDisplayed()
        compose.onNodeWithText("第二首").assertIsDisplayed()
    }
