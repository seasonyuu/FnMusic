...
internal enum class MusicPage { Root, Tracks, Recent, Albums, Artists, Playlists, Favorites, LiquidGlass, Password, Appearance, DisplayMode, ThemeColor, Cache, LyricsSettings, AmllSettings, Quality, AdminLibraries, AdminUsers, AdminServer }
